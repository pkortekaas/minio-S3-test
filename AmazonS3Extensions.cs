...
namespace s3.test
{
    ...
    {
        public static async Task<HttpStatusCode> CopyFileAsync(this AmazonS3Client client, string bucketName,
        ...
        public static async Task<HttpStatusCode> DownloadFileAsync(this AmazonS3Client client, string bucketName,
                                                                    string path, Stream stream)
        {
